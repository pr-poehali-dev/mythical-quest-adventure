...
export default function Promo() {
  ...
  return (
    <>
      {/* Мобильная версия */}
      <div className="md:hidden flex flex-col" style={{ backgroundColor: "#faf7f4" }}>
        <div className="relative w-full flex justify-center pt-10">
          <div className="relative h-64 w-full">
            ...
            />
            <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, #faf7f4 0%, transparent 8%, transparent 85%, #faf7f4 100%)" }} />
          </div>
        </div>
        <div className="px-6 pb-12 pt-2 flex flex-col gap-4">
          <h2 className="font-serif text-3xl font-bold italic text-neutral-900 leading-tight">
      ...
      <div
        ref={container}
        className="relative hidden md:flex items-center justify-center h-screen overflow-hidden"
        style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)", backgroundColor: "#faf7f4" }}
      >
        <div className="fixed top-[-10vh] left-0 h-[120vh] w-full flex items-center justify-start" style={{ backgroundColor: "#faf7f4" }}>
          <motion.div style={{ y }} className="relative h-full w-1/2 flex items-center justify-start">
          ...
          <div className="absolute right-8 lg:right-16 top-1/2 -translate-y-1/2 max-w-xs lg:max-w-sm flex flex-col gap-5">
