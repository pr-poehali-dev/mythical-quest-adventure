...
const roses = [
  ...
  },
  {
    ...
    fullDescription: [
      ...
      "Крепкий стебель с глянцевой листвой и тонкий фруктовый аромат придают букету особую глубину и благородство. 🌿✨ Этот сорт отличается высокой потребностью в воде — используйте просторную вазу и погружайте стебли минимум на 70%. 💧",
