...
const roses = [
  ...
  },
  {
    ...
    fullDescription: [
      "Лепестки Saida переливаются благородными оттенками розовой пудры, плавно переходя в деликатный кремовый по краям — настоящий шёлк в форме цветка. 🌸",
      "Крепкий стебель с глянцевой листвой и тонкий фруктовый аромат придают букету особую глубину и благородство. 🌿✨",
      "Saida достойна стать центральным элементом свадебного букета в пастельных тонах или изысканным подарком для тех, кто ценит утончённую красоту. 🎁",
    ],
  ...
  },
  {
    ...
    fullDescription: [
      "Представьте снежный обвал, застывший в изящной форме цветка — именно так можно описать эту удивительную розу. 🌨️✨",
      "Белоснежные лепестки с едва уловимым кремовым отливом у сердцевины образуют плотный бутон, который постепенно раскрывается, демонстрируя безупречную классическую форму. 🤍 Длинные стройные стебли подчёркивают благородство сорта. 🌿",
      "Avalanche станет сердцем свадебного букета или изысканным подарком для особого случая. 🎁",
    ],
